...
printf("\n\n The original Image"); /* get the coordinates for the
original image*/
line(xa,ya,xb,yb); /* draw the original image*/
line(xb,yb,xc,yc);
line(xc,yc,xa,ya);
printf("\n\n Enter the value tranlsation factor :"); /* get the
translation factor*/
scanf("%d",&tx);
printf("\n\n After Translation ");
x1a=xa+tx;
...
printf("\n\n Enter 1 for x-axis \n 2 for y-axis: "); /* get the choice
of shearing in the x or y axis*/
scanf("%d",&ch);
...
y5b=y3b+10;
y5c=y3c+10;
printf("\n\n After Reflection "); /* the final object after all the
transformations*/
